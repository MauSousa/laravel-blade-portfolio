<x-layouts.app>
    ...
    <div class="mb-6 flex items-center text-sm">
        ...
        <span
            class="text-gray-500 dark:text-gray-400">{{ __('Profile') }}</span>
    </div>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">
            {{ __('Update your name and email address') }}</p>
    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <form
                                ...
                                @method('DELETE')
                                <x-button
                                    type="danger">{{ __('Delete account') }}</x-button>
                            </form>
                        </div>
                    </div>
                </div>
